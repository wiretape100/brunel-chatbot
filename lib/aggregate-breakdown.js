...
export function aggregateBreakdownInstruction(message) {
  ...
  return [
    ...
    "If the article text gives only a range, highest/lowest values, selected examples, or only some requested breakdown categories, treat the article answer as incomplete and use linked data rows for the same public Data Hub post before saying exact breakdown values are unavailable.",
