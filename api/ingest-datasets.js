...
import { ingestDatasets } from "../lib/datasets.js";
...
export default async function handler(req, res) {
  ...
  if (req.method !== "GET" && req.method !== "POST") {
    sendError(res, 405, "Use GET or POST for dataset ingestion.");
    return;
  }
  ...
  try {
    ...
    sendError(res, 500, "Dataset ingestion failed.", error.message);
  }
}
